...
/*
    ...
    name: CCP_CalcInit
    function: Initialise the prediction order and coefficients for prediction filter used to predict the filter coefficients.
    pre: CT->TableType
...
int CCP_CalcInit(CodedTable* CT)
{
    ...
    switch (CT->TableType)
    {
        ...
        default:
            ...
            printf("PANIC: Illegal table type\n");
            retval = 1;
    }
